...
PRODUCT_COPY_FILES += \
    device/htc/vigor/gps.conf:system/etc/gps.conf
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/vigor/init.vigor.rc:root/init.vigor.rc \
    device/htc/vigor/init.usb.rc:root/init.usb.rc \
    device/htc/vigor/ueventd.vigor.rc:root/ueventd.vigor.rc \
    device/htc/vigor/init.vigor.usb.rc:root/init.vigor.usb.rc \
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/vigor/apns-conf.xml:system/etc/apns-conf.xml
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/vigor/modules/sequans_sdio.ko:system/lib/modules/sequans_sdio.ko 
